...
class ProductView(APIView):
    ...
    def get(self, request, pk):
        ...
        try:
            ...
            return Response(
                dict(success=True, data=product_serializer.data),
                status=status.HTTP_200_OK,
            )
        except Exception as error:
            return Response(
                dict(success=False, error="Producto no encontrado"),
    ...
    def put(self, request, pk):
        ...
        try:
            product = Product.objects.get(pk=pk)
            product_serializer = PostProductSerializer(
                product, data=request.data, partial=True
            )
            if product_serializer.is_valid():
                product_serializer.save()
                return Response(
                    product_serializer.data, status=status.HTTP_202_ACCEPTED
                )
            else:
                return Response(
                    dict(
                        ...
                        errors=[
                            x + "-" + y[0]
                            for x, y in zip(
                                product_serializer.errors.keys(),
            ...
            return Response(
                dict(success=False, errors=["Ocurrio un error al editar el producto"]),
                status=status.HTTP_400_BAD_REQUEST,
            )
    ...
    def delete(self, request, pk):
        ...
        try:
            ...
            return Response(
                dict(success=False, errors=["El producto no existe"]),
                status=status.HTTP_400_BAD_REQUEST,
            )
...
class ProductListView(APIView):
    ...
    def get(self, request):
        ...
        return Response(
            dict(success=True, data=products_serializer.data, status=status.HTTP_200_OK)
        )
    ...
    def post(self, request):
        ...
        try:
            ...
            return Response(
                dict(success=False, errors=["Ocurrió un error al guardar el producto"]),
                status=status.HTTP_400_BAD_REQUEST,
            )
